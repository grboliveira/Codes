...
class Fila {
    ...
    /**
     * Calcula e retorna o tamanho, em numero de elementos, da fila.
    ...
    public double media(Municipio municipio) {
        ...
        for (Celula i = primeiro; i.prox != null; i = i.prox) {
            municipio = i.prox.elemento;
            cont++;
            soma += municipio.getPopulacao();
