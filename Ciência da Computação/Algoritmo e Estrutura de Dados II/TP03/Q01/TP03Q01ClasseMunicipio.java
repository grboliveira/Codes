...
class Municipio {
  ...
  private Boolean consorcio;
	...
	public void ler(String entrada, int cont) {
		...
		Arq.openRead("/tmp/variaveisexternas.txt", "UTF8");
		String i;
		...
		Arq.openRead("/tmp/recursoshumanos.txt", "UTF8");
		...
		Arq.openRead("/tmp/planejamentourbano.txt", "UTF8");
		...
		Arq.openRead("/tmp/gestaoambiental.txt", "UTF8");
		...
		Arq.openRead("/tmp/recursosparagestao.txt", "UTF8");
		...
		Arq.openRead("/tmp/articulacaoointerinstitucional.txt", "UTF8");
