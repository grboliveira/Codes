/**
 * TP05Q04 - Ordenação Seleção Recursiva
...
class TP05Q04OrdenacaoSelecaoRecursiva {
...
class Lista {
    ...
    */
    ...
    public void selecaoAno() throws Exception {
        selecaoAno(0, n - 1);
    }

    /**
     * Ordena o array da classe pessoa pelo valor do Ano de modo crescente
     * @return tempo double tempo de execução do laço.
     * @throws Exception Se a lista estiver vazia ou a posicao for invalida.
     */
    public void selecaoAno(int min, int max) throws Exception {
        int menor, i;
        Municipio temp;
        ...
        if (min < max) {
            ...
            for(i = min + 1; i <= max; i++) {
                comparacao++;
                if(array[i].getAtualizacaoPlano() < array[menor].getAtualizacaoPlano()) {
                    comparacao++;
                    menor = i;
                }
            }
            ...
            temp = array[min];
            array[min] = array[menor];
            array[menor] = temp;
            movimentacao += 2;
            selecaoAno(min + 1, max);
        }
    }

    public void selecaoId() throws Exception {
        int linha;
    ...
    /**
     * Ordena o array da classe pessoa pelo valor do id de modo crescente
     * @return tempo double tempo de execução do laço.
     * @throws Exception Se a lista estiver vazia ou a posicao for invalida.
     */
    public void selecaoId(int min, int max) throws Exception {
        int menor, i;
        Municipio temp;
        ...
        if (min < max) {
            ...
            for(i = min + 1; i <= max; i++) {
                comparacao++;
                if(array[i].getId() < array[menor].getId()) {
                    comparacao++;
                    menor = i;
                }
            }
    ...
    public void selecaoFinal() throws Exception {
        int linha;
        for(linha = 0; array[linha].getAtualizacaoPlano() == 0; linha++);
        selecaoFinal(linha, n - 1);
    }

    /**
     * Ordena o array da classe pessoa pelo valor do Id para anos iguais de modo crescente
     * @return tempo double tempo de execução do laço.
     * @throws Exception Se a lista estiver vazia ou a posicao for invalida.
     */
    public void selecaoFinal(int min, int max) throws Exception {
        int menor, i;
        Municipio temp;
        ...
        if (min < max) {
            ...
            for(i = min + 1; i <= max; i++) {
                comparacao++;
                if(array[i].getAtualizacaoPlano() == array[menor].getAtualizacaoPlano() && array[menor].getId() > array[i].getId()) {
                    comparacao++;
                    menor = i;
                }
            }
