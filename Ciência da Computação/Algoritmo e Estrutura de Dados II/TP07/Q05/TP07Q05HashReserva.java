...
class Hash {
    ...
    public void inserir (Municipio municipio) {
        if(municipio != null) {
            ...
            int pos = h(municipio.getId());
 
            if(tabela[pos] == null) {
                tabela[pos] = municipio;
            } else if (reserva < m2){
                tabela[m1 + reserva] = municipio;
                reserva++;
            }
        }
    }
...
class TP07Q05HashReserva {
    public static void main(String[] args) throws Exception {
        ...
        int comparacao = hash.getComparacao();
